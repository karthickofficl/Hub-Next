...
const CreateAssigning = () => {
  return (
    <div className="border-b border-gray-900/10 pb-12">
      <h2 className="text-base/7 font-semibold text-gray-900 font-[family-name:var(--interSemiBold)]">Personal Information</h2>
      <p className="mt-1 text-sm/6 text-gray-600 font-[family-name:var(--interRegular)]">Use a permanent address where you can receive mail.</p>

      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div className="sm:col-span-3">
          <label htmlFor="first-name" className="block text-sm/6 font-medium text-gray-900 font-[family-name:var(--interRegular)]">First name</label>
          <div className="mt-2">
        ...
        <div className="sm:col-span-3">
          <label htmlFor="last-name" className="block text-sm/6 font-medium text-gray-900 font-[family-name:var(--interRegular)]">Last name</label>
          <div className="mt-2">
